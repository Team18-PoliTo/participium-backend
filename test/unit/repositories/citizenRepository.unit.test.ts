...
describe('CitizenRepository', () => {
    ...
    describe('findById', () => {
        it('findById(): returns citizen when found', async () => {
            const citizen = { id: 5, email: 'user@test.com', username: 'testuser' } as CitizenDAO;
    ...
    describe('findByUsername', () => {
        ...
        it('findByUsername(): returns null when username not found', async () => {
            ...
            expect(ormRepoMock.findOne).toHaveBeenCalledWith({ where: { username: 'nonexistent' } });
            expect(res).toBeNull();
        });
    });
    ...
    describe('update', () => {
        ...
        it('update(): can update single field', async () => {
            ...
            expect(ormRepoMock.update).toHaveBeenCalledWith({ id: 7 }, { username: 'newusername' });
        });
    });
});